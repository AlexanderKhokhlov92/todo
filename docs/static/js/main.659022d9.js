/*! For license information please see main.659022d9.js.LICENSE.txt */
;(() => {
  'use strict'
  var e = {
      730: (e, n, t) => {
        ...
        function Bl() {
          if (!Al && null !== jl) {
            ...
            try {
              ...
              throw (null !== jl && (jl = jl.slice(e + 1)), Ke(Ze, Bl), l)
            } finally {
              ;(kn = n), (Al = !1)
            }
          }
        ...
        function Ku(e, n, t) {
          ...
          switch ((na(n), n.tag)) {
            ...
            case 19:
              if ((El(Za), null === (o = n.memoizedState))) return Qu(n), null
        ...
        function Ss() {
          if (null !== qi) {
            var e = wn(Yi),
              ...
              t = kn
            try {
              if (((Ni.transition = null), (kn = 16 > e ? 16 : e), null === qi))
                var r = !1
              else {
                if (((e = qi), (qi = null), (Yi = 0), 0 !== (6 & Pi)))
                  throw Error(a(331))
                var l = Pi
  ...
  function p(e) {
    return (
      e &&
      e.map((e, n) => r.createElement(e.tag, f({ key: n }, e.attr), p(e.child)))
    )
  }
  function m(e) {
    return (n) => r.createElement(h, s({ attr: f({}, e.attr) }, n), p(e.child))
  }
  function h(e) {
    var n = (n) => {
      var t,
        { attr: l, size: a, title: o } = e,
        c = i(e, u),
        d = a || n.size || '1em'
      return (
        ...
        r.createElement(
          ...
          s(
            ...
            {
              className: t,
              style: f(f({ color: e.color || n.color }, n.style), e.style),
              height: d,
              width: d,
    ...
    return void 0 !== o ? r.createElement(o.Consumer, null, (e) => n(e)) : n(a)
  }
  function v(e) {
    return m({
      tag: 'svg',
  ...
  const g = 'TodoForm_form__+01JW',
    y = 'TodoForm_formSubmitButton__YGzwg',
    b = 'TodoForm_formInput__-TTSa',
    k = 'TodoForm_icon__N2jAf'
  var w = t(579)
  const S = (e) => {
      let { addTodo: n } = e
      ...
      return (0, w.jsxs)('form', {
        ...
        children: [
          ...
          (0, w.jsx)('button', {
            className: y,
            type: 'submit',
            children: (0, w.jsx)(v, { className: k }),
          }),
        ],
      })
    },
    x = 'Todo_todo__JGmyt',
    _ = 'Todo_todoContainer__Km0A5',
    E = 'Todo_checkboxWrapper__d+HKn',
    C = 'Todo_label__2ZSWJ',
    N = 'Todo_checkbox__9UbhH',
    P = 'Todo_completedTodo__6dI8L',
    z = 'Todo_todoText__9yE+P',
    T = (e) => {
      let { todo: n, toggleTodo: t } = e
      const r = 'checkbox-'.concat(n.id)
      return (0, w.jsxs)('div', {
        className: _,
        children: [
          (0, w.jsx)('div', {
            className: ''.concat(x, ' ').concat(n.isCompleted ? P : ''),
            children: (0, w.jsx)('p', { className: z, children: n.text }),
          }),
          (0, w.jsxs)('div', {
            className: E,
            children: [
              (0, w.jsx)('input', {
                ...
                className: N,
                type: 'checkbox',
                checked: n.isCompleted || !1,
                id: r,
              }),
              (0, w.jsx)('label', { className: C, htmlFor: r }),
            ],
          }),
        ],
      })
    ...
    L = (e) => {
      let { todos: n, toggleTodo: t } = e
      return (0, w.jsx)('div', {
        children: n.map((e) => (0, w.jsx)(T, { todo: e, toggleTodo: t }, e.id)),
      })
    }
  const O = {
    randomUUID:
  ...
  for (var D = [], I = 0; I < 256; ++I) D.push((I + 256).toString(16).slice(1))
  function j(e) {
  ...
  const U = function (e, n, t) {
    ...
    A = 'TodosActions_todosActionsWrapper__Od9Bl',
    V = 'TodosActions_incompleteTodoCounter__gh7Cv',
    B = 'TodosActions_deleteButton__9RzIR',
    $ = (e) => {
      let { children: n, incompleteTodo: t, onDeleteCompleted: r } = e
      return (0, w.jsxs)('div', {
        className: A,
        children: [
          (0, w.jsxs)('p', { className: V, children: [t, ' items left'] }),
          n,
          (0, w.jsx)('button', {
            className: B,
            onClick: r,
    ...
    H = 'FilterButtons_button__KOJLz',
    W = 'FilterButtons_buttonWrapper__ftnXt',
    Q = (e) => {
      let { filter: n, onChange: t } = e
      return (0, w.jsxs)('div', {
        className: W,
        children: [
          (0, w.jsx)('button', {
          ...
          (0, w.jsx)('button', {
            className: H,
            onClick: () => t('completed'),
            disabled: 'completed' === n,
            children: 'Completed',
          }),
        ],
      })
    },
    K = 'FadingText_fadeContainer__gZ3Hx',
    q = 'FadingText_fadeText__vAndx',
    Y = 'FadingText_show__vRO0B',
    X = (e) => {
      let { texts: n, interval: t } = e
      const [l, a] = (0, r.useState)(0),
        [o, u] = (0, r.useState)(!0)
      return (
        (0, r.useEffect)(() => {
          const e = setInterval(() => {
        ...
        (0, w.jsx)('div', {
          ...
          children: n.map((e, n) =>
            (0, w.jsx)(
              'div',
              {
                className: ''.concat(q, ' ').concat(n === l && o ? Y : ''),
                children: e,
              },
              n
            )
  ...
  const G = function () {
    const [e, n] = (0, r.useState)([]),
      [t, l] = (0, r.useState)('all'),
      a = (0, r.useMemo)(
        () =>
          e.filter((e) =>
            'active' === t ? !e.isCompleted : 'completed' !== t || e.isCompleted
          ),
        [e, t]
      ),
      o = (0, r.useMemo)(() => e.filter((e) => !e.isCompleted).length, [e])
    return (0, w.jsxs)('div', {
      className: 'App light',
      children: [
        (0, w.jsx)('h1', { className: 'app_main-title', children: 'todos' }),
        (0, w.jsx)(S, {
          addTodo: (t) => {
            if (!t.trim()) return
            const r = { id: U(), text: t, isCompleted: !1 }
            n([...e, r])
          },
        }),
        (0, w.jsx)(L, {
          toggleTodo: (t) => {
            n(
              e.map((e) =>
                e.id === t ? { ...e, isCompleted: !e.isCompleted } : e
              )
            )
          },
          todos: a,
  ...
  l.createRoot(document.getElementById('root')).render(
    (0, w.jsx)(r.StrictMode, { children: (0, w.jsx)(G, {}) })
  )
})()
//# sourceMappingURL=main.659022d9.js.map
